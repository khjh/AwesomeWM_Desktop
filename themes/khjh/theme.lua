...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/khjh"
...
local mytextclock = wibox.widget.textclock("<span font='Tamzen 10'> </span>%H:%M ")
...
theme.volume = lain.widget.alsabar({
    width = 100, border_width = 0, ticks = true, ticks_size = 6,
...
theme.volume.bar:buttons(awful.util.table.join (
          awful.button({}, 1, function()
            awful.spawn.with_shell(string.format("%s -e alsamixer --no-color", awful.util.terminal))
          end),
...
--            mytextclock,
    ...
    --s.mybottomwibox = awful.wibar({ position = "bottom", screen = s,  height = 28, bg = theme.bg_normal, fg = theme.fg_normal })
